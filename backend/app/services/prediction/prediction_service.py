...
def format_tree_message(trees: float) -> str:
    if trees < 0.5:
        return "Use the window to help a sapling take root 🌱"
    elif trees < 1.5:
        return "Use the window to plant a tree today 🌳"
    elif trees < 3:
        return "Use the window to plant two trees 🌳🌳"
    elif trees < 5:
        return "Use the window to grow a small grove 🌲🌳🌲"
    elif trees < 10:
        return "Use the window to restore a patch of forest 🌳🌳🌳🌳🌳"
    else:
        return "Use the window to make a forest flourish 🌳🌲🌳🌲🌳"
...
async def generate_predictions(
    ...
    try:
        ...
        if len(best_block) > 1:
            step = best_block.iloc[1]["datetime"] - best_block.iloc[0]["datetime"]
        else:
        ...
        return {
            ...
            "recommended_window": {
                ...
                "end": best_block.iloc[-1]["datetime"] + step,  # ✅ fixed end time
